export default class MinHeap {
    ...
    private heapifyDown(idx: number): void {
        ...
        // rightValue is the smallest, then we swap it with current value and heapifyDown on that subtree
        if (leftValue > rightValue && value > rightValue) {
            this.data[idx] = rightValue;
            this.data[rightIndex] = value;
            this.heapifyDown(rightIndex);
        }
        // leftValue is the smallest, then we swap it with current value and heapifyDown on that subtree
